...
import TimelineSection from "../components/core/HomePage/Timeline"
 const Home = () => {
   return (
     <div>
       <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col  justify-between gap-8 text-white'>
        {/* Become a  Instructoer Button */}
        <Link to={"/signup"}>
        ...
        <div className='-mt-3 w-[90%]  fond-bold text-center text-lg text-richblack-300'>
          ...
          <CodeBlocks
            ...
            heading={
              <div className="text-4xl w-[100%] lg:w-[50%] font-semibold">
                Unlock your
                <HighlightText text={"codig potential"}/>
